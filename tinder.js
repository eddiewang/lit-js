...
function TinderClient() {
   ...
   */
  var tinderGet = function(path, callback) {
   ...
   * @param {Function} callback the callback to invoke when the request completes
   */
  this.updatePreferences = function(newProfileObject, callback) {
    tinderPost('profile',
      newProfileObject,
      makeTinderCallback(callback));
  };
  ...
  this.getPopularLocation = function(callback) {
    tinderGet('/location/popular', makeTinderCallback(callback));
  }

  this.getFriends = function(callback) {
    tinderGet('/group/friends', makeTinderCallback(callback));
  }
